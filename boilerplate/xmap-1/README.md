...
This section contains templates to add an xMapServer-1 basemap to JavaScript widgets. For advanced samples with additional xServer content, you can also check these external projects:
