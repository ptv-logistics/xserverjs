(function (root, factory) {
	...
	L.TileLayer.Provider.providers = {
	    Ptv: {
	        url: 'http://api{s}-xstwo.cloud.ptvgroup.com/services/rs/XMap/2.0/map/{z}/{x}/{y}',
	        options: {
	            maxZoom: 18,
	            attribution:
					'&copy; <a href="http://www.ptvgroup.com">PTV</a>, TOMTOM',
				subdomains: '1234'
	        },
	        variants: {
	            Silkysand: {
	                url: 'http://api{s}-xstwo.cloud.ptvgroup.com/services/rs/XMap/2.0/map/{z}/{x}/{y}/silkysand'
	            },
	            Sandbox: {
	                url: 'http://api{s}-xstwo.cloud.ptvgroup.com/services/rs/XMap/2.0/map/{z}/{x}/{y}/sandbox'
	            },
	            Gravelpit: {
	                url: 'http://api{s}-xstwo.cloud.ptvgroup.com/services/rs/XMap/2.0/map/{z}/{x}/{y}/gravelpit'
	            }	        }
	    },
		OpenStreetMap: {
